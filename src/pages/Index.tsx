    ...
    <div className="section-marker" aria-hidden="true">
      ...
      <style>{`
        .section-marker {
          ...
          animation: marker-in .6s ease forwards;
          animation-delay: .1s;
        }
        ...
        .marker-line{
          ...
          background: linear-gradient(90deg, rgba(148,163,184,.4) 0%, transparent 100%);
        }
  ...
  return (
    <div className="min-h-screen bg-[#ebe9e6] overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen overflow-hidden pt-[88px] sm:pt-[96px] bg-[#ebe9e6]">
        ...
        {/* Градиент слева для читаемости текста, не заливает лицо */}
        <div className="absolute inset-0 pointer-events-none z-[1]" aria-hidden>
          <div className="absolute inset-0 bg-gradient-to-r from-[#ebe9e6] via-[#ebe9e6]/85 to-transparent md:via-[#ebe9e6]/60 md:to-transparent" />
        </div>

        {/* Контент — слева, с безопасной зоной */}
        <div className="relative z-[2] max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-12 items-center">
            <div className="max-w-xl lg:max-w-2xl lg:col-span-6 fade-in-view">
              ...
              {/* Подзаголовок — располагается примерно рядом с линией головы */}
            ...
            {/* Пустая колонка-буфер, чтобы текст не наползал на лицо на десктопе */}
            <div className="hidden lg:block lg:col-span-6" />
          </div>
        </div>

        {/* CTA — в самом низу фото */}
        <div className="hero-cta">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            {/* Плашки оплаты — одна строка на нормальных ширинах */}
            <div className="flex items-center gap-2 text-[11px] sm:text-xs md:text-sm text-gray-700 flex-wrap md:flex-nowrap">
              <span className="px-2.5 py-1.5 bg-black text-white rounded-lg font-medium whitespace-nowrap">Apple Pay</span>
              <span className="px-2.5 py-1.5 bg-blue-600 text-white rounded-lg font-medium whitespace-nowrap">Google Pay</span>
              <span className="px-2.5 py-1.5 bg-white/90 backdrop-blur-sm rounded-lg border border-gray-200/70 font-medium whitespace-nowrap">Visa</span>
              <span className="px-2.5 py-1.5 bg-white/90 backdrop-blur-sm rounded-lg border border-gray-200/70 font-medium whitespace-nowrap">MasterCard</span>
            </div>
          </div>

          {/* подпись «Безопасная оплата / Stripe» отдельно, ниже */}
          <div className="mt-2 flex items-center gap-2 text-[11px] sm:text-xs text-gray-700 justify-center">
        ...
        <style>{`
          ...
          /* Фото героя: адаптивное расположение, без жёсткой «стенки» справа */
          .hero-photo {
            position: absolute;
            inset: 0;
            width: 100%;
            height: 100%;
            object-fit: cover;
            object-position: 72% center; /* чуть левее, чтобы лицо не упиралось в край */
            transform: none;
          }

          /* На планшете/десктопе держим лицо правее текста, но не в самом правом краю */
          @media (min-width: 1024px) {
            .hero-photo {
              object-fit: contain;
              width: auto;
          ...
          /* Мобилка — фото снизу, больше пространства для заголовков сверху */
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {[
              ...
              <div
                key={i}
                className="card-premium bg-white rounded-2xl p-5 border border-emerald-100/60 hover:border-emerald-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 fade-in-view"
      ...
      <section id="whats-included" className="relative py-8 sm:py-12 lg:py-14 bg-[linear-gradient(180deg,#f8f9fb_0%,#e8ecf1_50%,#ffffff_100%)]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 fade-in-view">
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-3">
              Что входит в{" "}
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">систему скриптов</span>
            </h2>
              ...
              <div key={k} className="card-premium rounded-2xl border border-gray-100 p-5 bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group fade-in-view" style={{ animationDelay: `${k * 0.05}s` }}>
                <div className="mb-3 inline-flex items-center justify-center">
                  <img
                    src={item.img}
                    alt=""
                    className={`${item.big ? "w-14 h-14" : "w-12 h-12"} object-contain group-hover:scale-105 transition-transform duration-300`}
                    loading="lazy"
                  />
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={i} className="card-premium rounded-2xl p-5 text-center bg-white shadow-sm border border-purple-100/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 fade-in-view" style={{ animationDelay: `${i * 0.07}s` }}>
                <div className="mb-4">
      ...
      {/* 06 - Immediate (underline тоньше и ближе) */}
      <section id="immediate" className="relative py-8 sm:py-12 lg:py-14 bg-[linear-gradient(180deg,#f2f9f6_0%,#ffffff_75%)]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 fade-in-view">
            ...
            <div className="mx-auto mt-2 h-[2px] w-24 sm:w-28 bg-gradient-to-r from-teal-500 via-cyan-500 to-teal-500 rounded-full"></div>
          </div>
      ...
      {/* 08 - Offer (оранжевая плашка длиннее/аккуратнее, оплаты в строку) */}
          ...
          <div className="max-w-lg mx-auto">
            <div className="rounded-3xl p-7 sm:p-8 bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-2xl relative overflow-hidden hover:shadow-3xl transition-all duration-300 hover:scale-[1.01] fade-in-view">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="text-xs text-gray-300 mb-6 whitespace-nowrap overflow-x-auto text-center">
