...
function SectionMarker({ n }: { n: string }) {
  return (
    <div className="section-marker" aria-hidden="true">
      ...
      <style>{`
        .section-marker{position:absolute;left:1rem;top:1rem;display:flex;align-items:center;gap:10px;z-index:10;opacity:0;transform:translateY(10px);animation:marker-in .8s cubic-bezier(.4,0,.2,1) forwards;animation-delay:.2s}
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24 bg-[#efece8]">
          ...
          <div className="max-w-xl lg:max-w-2xl fade-in-view">
            ...
            <div className="mt-6 sm:mt-8">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center gap-2.5 px-6 sm:px-7 lg:px-8 py-3.5 sm:py-4 bg-gray-900 text-white rounded-xl text-base sm:text-lg font-bold hover:bg-gray-800 transition-all hover:-translate-y-0.5 hover:shadow-xl min-h-[52px]"
        ...
        <style>{`
          ...
          .hero-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(to right,
            ...
            rgba(250,245,240,0.30) 55%,
            transparent 100%)}
          @media (max-width:767px){
            .hero-overlay{background:linear-gradient(to bottom,
              rgba(250,245,240,0.96) 0%,
              rgba(250,245,240,0.90) 32%,
              rgba(250,245,240,0.40) 64%,
              transparent 100%)}
          }
          .result-subtitle{position:relative;padding-top:10px;margin-top:6px}
          .result-subtitle::before{content:'';position:absolute;top:0;left:0;width:64px;height:2px;background:linear-gradient(90deg,rgba(59,130,246,.65) 0%, transparent 100%);border-radius:2px}
        `}</style>
      </section>
      ...
      <section id="comparison" className="relative py-8 sm:py-12 lg:py-16 section-bg-1">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 fade-in-view">
            ...
            <p className="text-base sm:text-lg text-gray-600">Сравните результаты до и после внедрения скриптов</p>
          </div>

          <div className="grid lg:grid-cols-2 gap-5 sm:gap-6 max-w-5xl mx-auto">
            <div className="card-premium bg-white rounded-3xl p-6 sm:p-7 border border-gray-100 hover:shadow-2xl transition-all duration-500">
              ...
              <ul className="space-y-3.5 text-base text-gray-800">
                {[
      ...
      <section id="why" className="relative py-8 sm:py-12 lg:py-16 section-bg-2">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 fade-in-view">
            ...
            <p className="text-base sm:text-lg text-gray-600">Каждая потерянная заявка — это упущенная прибыль</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={i} className="card-premium rounded-3xl border border-gray-100 p-5 sm:p-6 text-center bg-white hover:shadow-2xl transition-all duration-500">
                <div className="mb-4 inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <section id="for" className="relative py-8 sm:py-12 lg:py-16 section-bg-1">
        <SectionMarker n="03" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            {[
              ...
              <div key={i} className="card-premium bg-white rounded-3xl p-6 border border-emerald-100/50 hover:border-emerald-200 hover:shadow-2xl transition-all duration-500">
      ...
      <section id="whats-included" className="relative py-8 sm:py-12 lg:py-16 section-bg-2">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 fade-in-view">
            ...
            <p className="text-base sm:text-lg text-gray-600">Полный набор инструментов для увеличения продаж</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={k} className="card-premium rounded-3xl border border-gray-100 p-5 sm:p-6 bg-white hover:shadow-2xl transition-all duration-500">
                <div className="mb-3 inline-flex items-center justify-center">
                  <img src={item.img} alt="" className={`${item.big ? "w-16 h-16" : "w-12 h-12"} object-contain`} loading="lazy" />
                </div>
      ...
      <section id="bonuses" className="relative py-8 sm:py-12 lg:py-14 bg-gradient-to-b from-purple-50/40 via-pink-50/20 to-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center mb-8 fade-in-view">
            ...
            <p className="text-base sm:text-lg text-gray-600">Суммарная ценность — 79€. Сегодня идут бесплатно со скриптами</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={i} className="card-premium rounded-3xl p-5 text-center bg-white shadow-sm border border-purple-100/50 hover:shadow-2xl transition-all duration-500">
                <div className="mb-4">
                  <img src={b.image} alt={`Бонус ${i + 1}`} className="w-28 h-40 sm:w-32 sm:h-44 mx-auto object-cover rounded-xl shadow" loading="lazy" />
                </div>
      ...
      <section id="immediate" className="relative py-8 sm:py-12 lg:py-16 section-bg-1">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 inline-block">
              Что изменится <span className="text-teal-600">сразу</span>
            </h2>
            <div className="mx-auto mt-3 h-[2px] w-28 bg-gradient-to-r from-teal-500 via-cyan-500 to-teal-500 rounded-full"></div>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 bg-white/85 backdrop-blur-[1px] p-5 rounded-2xl border border-teal-100 hover:shadow-xl transition-all duration-300">
                <div className="w-6 h-6 bg-teал-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <span className="text-base font-medium text-gray-800 leading-relaxed">{t}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="reviews" className="relative py-8 sm:py-12 lg:py-16 section-bg-2">
        <SectionMarker n="07" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-8">Отзывы клиентов</h2>

          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8 max-w-4xl mx-auto">
            {[1, 2, 4].map((n) => (
              <button
                key={n}
                className="group cursor-pointer rounded-2xl overflow-hidden border-2 border-gray-200 hover:border-blue-400 hover:shadow-xl transition-all duration-300"
          ...
          <div className="flex gap-3 sm:gap-4 justify-center items-center overflow-x-auto pb-2 reels-container">
            {INSTAGRAM_REELS.slice(0, 3).map((url, idx) => (
              <div
                key={url}
                className={`${idx === 1 ? 'reel-card-featured' : 'reel-card-small'} rounded-2xl overflow-hidden border-2 ${idx === 1 ? 'border-blue-400 shadow-xl' : 'border-gray-200'} flex-shrink-0 hover:shadow-2xl hover:scale-105 transition-all duration-500`}
              >
      ...
      <section id="offer" className="relative py-8 sm:py-12 lg:py-16 bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-lg mx-auto">
            <div className="rounded-3xl p-7 sm:p-8 bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-2xl relative overflow-hidden transition-all duration-500">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="mb-6">
                  <div className="inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-orange-500 to-red-500 px-5 py-2.5">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="border-2 border-gray-200 rounded-2xl overflow-hidden bg-white hover:shadow-xl transition-all duration-500">
                <button
                  onClick={() => toggleFaq(i)}
